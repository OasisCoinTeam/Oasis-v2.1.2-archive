Contributing to Oasis Core
============================

The Oasis Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Oasis Core project, and is not to be
confused with overall Oasis Network Protocol consensus changes.

Whether a pull request is merged into Oasis Core rests with the project merge
...
Patches that change Oasis consensus rules are considerably more involved than
...
Where a patch set proposes to change the Oasis consensus, it must have been
...
The project leader is the release manager for each Oasis Core release.
