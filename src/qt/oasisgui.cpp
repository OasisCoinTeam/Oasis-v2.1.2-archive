...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Oasis address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and oasis: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOASIS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Oasis Core"), this);
    aboutAction->setStatusTip(tr("Show information about Oasis Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Oasis"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Oasis addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Oasis addresses"));
    ...
    openAction->setStatusTip(tr("Open a Oasis: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Oasis Core help message to get a list with possible Oasis command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Oasis network", "", count));
}
