...
public:
    ...
    void setZOASISControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzOASIS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzOASIS_clicked();
    void on_pushButtonZOASISControl_clicked();
