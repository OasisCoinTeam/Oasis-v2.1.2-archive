                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received OASIS from zOASIS"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOASIS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOASIS));
