...
In order to support loading of multiple wallets in oasis-qt, a few changes in the UI architecture will be needed.
...
Changes to oasis.cpp
----------------------
oasis.cpp is the entry point into oasis-qt, and as such, will require some minor modifications to provide hooks for
